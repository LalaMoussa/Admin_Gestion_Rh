...
public class ProjetDto {
    ...
    private List<EvaluationDto> evaluations; // Changez ici de List<Evaluation> à List<EvaluationDto>
    ...
    public static ProjetDto mapToProjetDto(Projet projet) {
        ...
        projetDto.setEvaluations(projet.getEvaluations().stream()
                .map(evaluation -> EvaluationMapper.INSTANCE.toDTO(evaluation))
